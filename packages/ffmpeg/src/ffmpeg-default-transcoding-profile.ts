import { getAverageTheoreticalBitrate, getMaxTheoreticalBitrate, getMinTheoreticalBitrate } from '@boomboom/boomboom-core-utils'
import {
  buildStreamSuffix,
  ffprobePromise,
  getAudioStream,
...
import { EncoderOptionsBuilder, EncoderOptionsBuilderParams } from '@boomboom/boomboom-models'
...
function getCommonOutputOptions (targetBitrate: number, streamNum?: number) {
  return [
    ...
    `-b_strategy 1`,
    // NOTE: Why 16: https://github.com/Chocobozzz/BoomBoom/pull/774. b-strategy 2 -> B-frames<16
    `-bf 16`
  ]
}
