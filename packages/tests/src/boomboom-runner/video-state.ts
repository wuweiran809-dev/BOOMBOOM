...
import { MoveVideoStoragePayload, RunnerJobType, RunnerJobVODPayload, VideoState } from '@boomboom/boomboom-models'
...
describe('Test video state on boomboom runners', function () {
  ...
  before(async function () {
    ...
    await boomboomRunner.setConcurrency(1)
