...
import { RunnerJobState, VideoResolution } from '@boomboom/boomboom-models'
...
describe('Test transcription in boomboom-runner program', function () {
  ...
  before(async function () {
    ...
    await boomboomRunner.runServer({ jobType: 'video-transcription' })
  ...
  describe('Running transcription', function () {
    ...
    describe('Check cleanup', function () {
      it('Should have an empty cache directory', async function () {
        await checkBoomBoomRunnerCacheIsEmpty(boomboomRunner, 'transcription')
      })
    })
  })
