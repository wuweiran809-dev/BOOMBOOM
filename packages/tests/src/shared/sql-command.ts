...
import { FileStorageType, RunnerJobPayload, VideoImportStateType } from '@boomboom/boomboom-models'
...
export class SQLCommand {
  ...
  private getSequelize () {
    ...
    const dbname = 'boomboom_test' + this.server.internalServerNumber
    const username = 'boomboom'
    const password = 'boomboom'
