...
export class BoomBoomRunnerProcess {
  private app?: ChildProcess
  private runOptions: RunOptions

  constructor (private readonly server: BoomBoomServer) {
  }
  ...
  registerBoomBoomInstance (options: {
  ...
  unregisterBoomBoomInstance (options: {
    runnerName: string
  }) {
  ...
  async listRegisteredBoomBoomInstances () {
  ...
  private getRunnerPath () {
    return join(root(), 'apps', 'boomboom-runner', 'dist', 'boomboom-runner.mjs')
  }
