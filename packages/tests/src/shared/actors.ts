...
import { Account, AccountSummary, HttpStatusCode, VideoChannel, VideoChannelSummary } from '@boomboom/boomboom-models'
import { makeRawRequest, BoomBoomServer } from '@boomboom/boomboom-server-commands'
...
export async function checkActorFilesWereRemoved (filename: string, server: BoomBoomServer) {
