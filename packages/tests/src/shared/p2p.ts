...
import { OverloadedParameters } from '@boomboom/boomboom-typescript-utils'
...
export async function parseTorrentVideo (server: BoomBoomServer, file: VideoFile): Promise<OverloadedParameters<ReturnType<ParseTorrent>>> {
