...
import { getVideoStreamDimensionsInfo, getVideoStreamFPS } from '@boomboom/boomboom-ffmpeg'
import { LiveVideo, VideoResolution, VideoStreamingPlaylistType } from '@boomboom/boomboom-models'
import { ObjectStorageCommand, BoomBoomServer } from '@boomboom/boomboom-server-commands'
...
async function checkUnsavedLiveCleanup (server: BoomBoomServer, videoUUID: string, hlsPath: string) {
  let live: LiveVideo
