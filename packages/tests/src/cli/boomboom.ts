...
describe('Test CLI wrapper', function () {
  ...
  const cmd = 'node ./apps/boomboom-cli/dist/boomboom.mjs'
  ...
  describe('Manage plugins', function () {
    it('Should install a plugin', async function () {
      ...
      await cliCommand.execWithEnv(`${cmd} plugins install --npm-name boomboom-plugin-hello-world`)
    })
    ...
    it('Should list installed plugins', async function () {
      ...
      expect(stdout).to.contain('boomboom-plugin-hello-world')
    })

    it('Should uninstall the plugin', async function () {
      const { stdout } = await cliCommand.execWithEnv(`${cmd} plugins uninstall --npm-name boomboom-plugin-hello-world`)

      expect(stdout).to.not.contain('boomboom-plugin-hello-world')
    })

    it('Should install a plugin in requested version', async function () {
      this.timeout(60000)

      await cliCommand.execWithEnv(`${cmd} plugins install --npm-name boomboom-plugin-hello-world --plugin-version 0.0.17`)
    })
    ...
    it('Should install a plugin in requested beta version', async function () {
      ...
      await cliCommand.execWithEnv(`${cmd} plugins install --npm-name boomboom-plugin-hello-world --plugin-version 0.0.21-beta.1`)
      ...
      await cliCommand.execWithEnv(`${cmd} plugins uninstall --npm-name boomboom-plugin-hello-world`)
    })
  })

  describe('Manage video redundancies', function () {
    let anotherServer: BoomBoomServer
