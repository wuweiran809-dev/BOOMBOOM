...
import { TranscriptFile } from '@boomboom/boomboom-transcription'
import { TranscriptFileEvaluator } from '@boomboom/boomboom-transcription-devtools'
...
describe('Transcript File Evaluator', function () {
  const transcriptDirectory = join(tmpdir(), 'boomboom-transcription', 'transcript-file-evaluator')
