...
import { Ctranslate2Transcriber, OpenaiTranscriber, TranscriptFile, TranscriptionModel } from '@boomboom/boomboom-transcription'
import { TranscriptFileEvaluator, levenshteinDistance } from '@boomboom/boomboom-transcription-devtools'
...
describe('Whisper CTranslate2 transcriber', function () {
  const tmpDirectory = join(tmpdir(), 'boomboom-transcription')
