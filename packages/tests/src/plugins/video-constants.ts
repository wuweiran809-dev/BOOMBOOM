...
import { HttpStatusCode, VideoPlaylistPrivacy, VideoPrivacy } from '@boomboom/boomboom-models'
...
describe('Test plugin altering video constants', function () {
  ...
  it('Should uninstall the plugin and reset languages, categories, licences and privacies', async function () {
    await server.plugins.uninstall({ npmName: 'boomboom-plugin-test-video-constants' })
