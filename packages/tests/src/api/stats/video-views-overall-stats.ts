...
import { VideoStatsOverall } from '@boomboom/boomboom-models'
import { buildUUID } from '@boomboom/boomboom-node-utils'
import { BoomBoomServer, cleanupTests, stopFfmpeg, waitJobs } from '@boomboom/boomboom-server-commands'
 ...
 */
async function simulateComplexViewers (servers: BoomBoomServer[], videoUUID: string, useSessionId: boolean) {
