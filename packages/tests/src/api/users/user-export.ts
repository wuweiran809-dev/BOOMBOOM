...
import { hasAudioStream, hasVideoStream } from '@boomboom/boomboom-ffmpeg'
import {
  AccountExportJSON,
  ActivityPubActor,
...
function runTest (withObjectStorage: boolean) {
  ...
  let remoteServer: BoomBoomServer
  ...
  it('Should have a valid ZIP for root account', async function () {
    ...
    const files = [
      ...
      'boomboom/account.json',
      'boomboom/blocklist.json',
      'boomboom/channels.json',
      'boomboom/comments.json',
      'boomboom/dislikes.json',
      'boomboom/follower.json',
      'boomboom/following.json',
      'boomboom/likes.json',
      'boomboom/user-settings.json',
      'boomboom/video-playlists.json',
      'boomboom/videos.json',
      'boomboom/watched-words-lists.json',
      'boomboom/automatic-tag-policies.json'
    ]
  ...
  it('Should have a valid export in BoomBoom format', async function () {
    this.timeout(120000)

    const zip = await downloadZIP(server, noahId)

    {
      const json = await parseZIPJSONFile<BlocklistExportJSON>(zip, 'boomboom/blocklist.json')
    ...
    {
      const json = await parseZIPJSONFile<FollowersExportJSON>(zip, 'boomboom/follower.json')
    ...
    {
      const json = await parseZIPJSONFile<FollowingExportJSON>(zip, 'boomboom/following.json')
    ...
    {
      const json = await parseZIPJSONFile<LikesExportJSON>(zip, 'boomboom/likes.json')
    ...
    {
      const json = await parseZIPJSONFile<DislikesExportJSON>(zip, 'boomboom/dislikes.json')
    ...
    {
      const json = await parseZIPJSONFile<UserSettingsExportJSON>(zip, 'boomboom/user-settings.json')
    ...
    {
      const json = await parseZIPJSONFile<AccountExportJSON>(zip, 'boomboom/account.json')
    ...
    {
      const json = await parseZIPJSONFile<VideoPlaylistsExportJSON>(zip, 'boomboom/video-playlists.json')
    ...
    {
      const json = await parseZIPJSONFile<ChannelExportJSON>(zip, 'boomboom/channels.json')
    ...
    {
      const json = await parseZIPJSONFile<CommentsExportJSON>(zip, 'boomboom/comments.json')
    ...
    {
      const json = await parseZIPJSONFile<UserVideoHistoryExportJSON>(zip, 'boomboom/video-history.json')
    ...
    {
      const json = await parseZIPJSONFile<VideoExportJSON>(zip, 'boomboom/videos.json')
    ...
    {
      const json = await parseZIPJSONFile<WatchedWordsListsJSON>(zip, 'boomboom/watched-words-lists.json')
    ...
    {
      const json = await parseZIPJSONFile<AutoTagPoliciesJSON>(zip, 'boomboom/automatic-tag-policies.json')
