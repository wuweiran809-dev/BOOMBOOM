...
import { HttpStatusCode, MyUser, OAuth2ErrorCode, BoomBoomProblemDocument } from '@boomboom/boomboom-models'
import {
  cleanupTests,
  createSingleServer,
  killallServers,
...
describe('Test oauth', function () {
  ...
  describe('OAuth client', function () {
    function expectInvalidClient (body: BoomBoomProblemDocument) {
  ...
  describe('Login', function () {
    function expectInvalidCredentials (body: BoomBoomProblemDocument) {
