...
import { HttpStatusCode, BoomBoomProblemDocument, ServerErrorCode } from '@boomboom/boomboom-models'
import {
  cleanupTests,
  ...
  describe('With a non followed instance', function () {
    ...
    describe('With an unlogged user', function () {
      ...
      it('Should not get the remote video', async function () {
        ...
        const doc = 'https://docs.joinboomboom.org/api-rest-reference.html#section/Errors/does_not_respect_follow_constraints'
