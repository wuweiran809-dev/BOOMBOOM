...
import { UserNotificationType, UserNotificationType_Type } from '@boomboom/boomboom-models'
import {
  cleanupTests,
...
async function checkNotifications (server: BoomBoomServer, token: string, expected: UserNotificationType_Type[]) {
