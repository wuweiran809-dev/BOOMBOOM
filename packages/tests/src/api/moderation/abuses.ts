...
import { AbuseMessage, AbusePredefinedReasonsString, AbuseState, AdminAbuse, UserAbuse } from '@boomboom/boomboom-models'
import {
  AbusesCommand,
  cleanupTests,
...
describe('Test abuses', function () {
  ...
  describe('Comment abuses', function () {
    async function getComment (server: BoomBoomServer, videoIdArg: number | string) {
  ...
  describe('Account abuses', function () {
    function getAccountFromServer (server: BoomBoomServer, targetName: string, targetServer: BoomBoomServer) {
