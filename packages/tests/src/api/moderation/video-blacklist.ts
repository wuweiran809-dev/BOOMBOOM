...
import { sortObjectComparator } from '@boomboom/boomboom-core-utils'
import { HttpStatusCode, UserAdminFlag, UserRole, VideoBlacklist, VideoBlacklistType, VideoPrivacy } from '@boomboom/boomboom-models'
import {
  BlacklistCommand,
  cleanupTests,
...
describe('Test video blacklist', function () {
  ...
  async function blacklistVideosOnServer (server: BoomBoomServer) {
