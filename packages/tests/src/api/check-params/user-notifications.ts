...
import { HttpStatusCode, UserNotificationSetting, UserNotificationSettingValue, UserNotificationType } from '@boomboom/boomboom-models'
import {
  cleanupTests,
  createSingleServer,
  makeGetRequest,
...
describe('Test user notifications API validators', function () {
  ...
  describe('When updating my notification settings', function () {
    ...
    const correctFields: UserNotificationSetting = {
      ...
      newBoomBoomVersion: UserNotificationSettingValue.WEB,
