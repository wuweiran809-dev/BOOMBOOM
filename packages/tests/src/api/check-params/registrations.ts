...
import { HttpStatusCode, HttpStatusCodeType, UserRegistrationState, UserRole } from '@boomboom/boomboom-models'
...
describe('Test registrations API validators', function () {
  ...
  describe('Register', function () {
    ...
    describe('When registering a new user or requesting user registration', function () {
      ...
      it('Should fail with a "boomboom" username', async function () {
        const fields = { ...baseCorrectParams, username: 'boomboom' }
