...
import { HttpStatusCode, LiveVideoCreate, VideoPrivacy, VideoResolution } from '@boomboom/boomboom-models'
...
async function createLive (server: BoomBoomServer, permanent: boolean) {
