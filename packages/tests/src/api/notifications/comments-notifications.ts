...
import { UserNotification, UserNotificationType, VideoCommentPolicy } from '@boomboom/boomboom-models'
import { BoomBoomServer, cleanupTests, setDefaultAccountAvatar, waitJobs } from '@boomboom/boomboom-server-commands'
...
describe('Test comments notifications', function () {
  ...
  const commentText = '**hello** <a href="https://joinboomboom.org">world</a>, <h1>what do you think about boomboom?</h1>'
  const expectedHtml = '<strong>hello</strong> <a href="https://joinboomboom.org" target="_blank" rel="noopener noreferrer">world</a>' +
    ', </p>what do you think about boomboom?'
