...
import { UserNotification, UserNotificationType, VideoPrivacy, VideoStudioTask } from '@boomboom/boomboom-models'
import { buildUUID } from '@boomboom/boomboom-node-utils'
import { cleanupTests, findExternalSavedVideo, BoomBoomServer, stopFfmpeg, waitJobs } from '@boomboom/boomboom-server-commands'
...
describe('Test user notifications', function () {
  ...
  describe('New live from my subscription notification', function () {
    ...
    async function createAndStreamLive (server: BoomBoomServer) {
  ...
  describe('New actor follow', function () {
    ...
    // BoomBoom does not support account -> account follows
