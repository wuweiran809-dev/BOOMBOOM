...
import { LiveVideoCreate, LiveVideoEventPayload, VideoPrivacy, VideoState, VideoStateType } from '@boomboom/boomboom-models'
import {
  BoomBoomServer,
  cleanupTests,
...
describe('Test live socket messages', function () {
  ...
  describe('Live socket messages', function () {
    ...
    it('Should correctly send a force end notification', async function () {
      ...
      const env = { BOOMBOOM_TEST_CONSTANTS_VIDEO_LIVE_CLEANUP_DELAY: '20000' }
