...
import { StreamSyncState, VideoImportState, VideoInclude, VideoPrivacy } from '@boomboom/boomboom-models'
...
describe('Test channel synchronizations', function () {
  ...
  function runSuite (mode: 'youtube-dl' | 'yt-dlp') {
    describe('Sync using ' + mode, function () {
      ...
      // it('Should import a remote BoomBoom channel', async function () {
      //   this.timeout(240_000)
      ...
      // it('Should keep synced a remote BoomBoom channel', async function () {
      //   this.timeout(240_000)
