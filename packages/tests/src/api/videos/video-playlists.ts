...
describe('Test video playlists', function () {
  ...
  describe('Element type', function () {
    let groupUser1: BoomBoomServer[]
    let groupWithoutToken1: BoomBoomServer[]
    let group1: BoomBoomServer[]
    let group2: BoomBoomServer[]
  ...
  describe('Playlist position', function () {
    ...
    async function getPosition (server: BoomBoomServer, options: { uuid: string }) {
    ...
    async function getPlaylistNames (server: BoomBoomServer) {
