...
import { getHLS } from '@boomboom/boomboom-core-utils'
import { HttpStatusCode, VideoDetails, VideoFile, VideoResolution } from '@boomboom/boomboom-models'
...
describe('Test generate download', function () {
  ...
  function runSuite (serverGetter: () => BoomBoomServer, objectStorage?: ObjectStorageCommand) {
