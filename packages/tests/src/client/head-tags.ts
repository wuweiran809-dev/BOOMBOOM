...
import { findAppropriateImage } from '@boomboom/boomboom-core-utils'
import { Account, HttpStatusCode, VideoPlaylistCreateResult } from '@boomboom/boomboom-models'
import { cleanupTests, makeGetRequest, BoomBoomServer } from '@boomboom/boomboom-server-commands'
...
describe('Test <head> HTML tags', function () {
  ...
  describe('Icons', function () {
    ...
    it('Should have valid favicon/ Graph tags on the common page', async function () {
      await indexPageTest('/about/boomboom')
