...
import { HttpStatusCode, VideoPlaylistCreateResult } from '@boomboom/boomboom-models'
import { cleanupTests, makeGetRequest, makeHTMLRequest, BoomBoomServer } from '@boomboom/boomboom-server-commands'
...
describe('Test index HTML generation', function () {
  ...
  describe('Instance tags', function () {
    ...
    it('Should update the customized configuration and have the correct index html tags', async function () {
      ...
      checkIndexTags(res.text, 'BoomBoom updated', 'my short description', 'body { background-color: red; }', config)
    })
