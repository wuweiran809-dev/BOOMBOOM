...
import { VideoPlaylistPrivacyType, VideoPrivacyType } from '@boomboom/boomboom-models'
import {
  VIDEO_CATEGORIES,
  VIDEO_LANGUAGES,
  VIDEO_LICENCES,
...
import { VideoConstantManagerFactory } from '@boomboom/boomboom-server/core/lib/plugins/video-constant-manager-factory.js'

describe('VideoConstantManagerFactory', function () {
  const factory = new VideoConstantManagerFactory('boomboom-plugin-constants')

  afterEach(() => {
    factory.resetVideoConstants('boomboom-plugin-constants')
  })
