import { About, ActorImageType, ActorImageType_Type, CustomConfig, HttpStatusCode, LogoType, ServerConfig } from '@boomboom/boomboom-models'
...
export class ConfigCommand extends AbstractCommand {
  ...
  async getIndexHTMLConfig (options: OverrideCommandOptions = {}) {
    ...
    const match = text.match('<script type="application/javascript">window.BoomBoomServerConfig = (".+?")</script>')
