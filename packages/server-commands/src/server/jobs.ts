...
import { arrayify, wait } from '@boomboom/boomboom-core-utils'
import { JobState, JobType, RunnerJobState } from '@boomboom/boomboom-models'
import { BoomBoomServer } from './server.js'

async function waitJobs (
  serversArg: BoomBoomServer[] | BoomBoomServer,
  options: {
...
async function expectNoFailedTranscodingJob (server: BoomBoomServer) {
