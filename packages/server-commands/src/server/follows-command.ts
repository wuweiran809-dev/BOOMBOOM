...
import { ActivityPubActorType, ActorFollow, FollowState, HttpStatusCode, ResultList, ServerFollowCreate } from '@boomboom/boomboom-models'
...
export class FollowsCommand extends AbstractCommand {
  ...
  removeFollower (options: OverrideCommandOptions & {
    ...
    const path = '/api/v1/server/followers/boomboom@' + options.follower.host
