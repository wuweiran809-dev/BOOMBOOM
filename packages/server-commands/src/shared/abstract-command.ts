...
import { HttpStatusCode, HttpStatusCodeType } from '@boomboom/boomboom-models'
import { buildAbsoluteFixturePath, getFileSize } from '@boomboom/boomboom-node-utils'
...
import type { BoomBoomServer } from '../server/server.js'
...
export abstract class AbstractCommand {
  constructor (
    protected server: BoomBoomServer
  ) {
  }
