...
export const clientFilterHookObject = {
  ...
  // Filter videojs options built for BoomBoom player
  'filter:internal.player.videojs.options.result': true,

  // Filter p2p media loader options built for BoomBoom player
...
export const clientActionHookObject = {
  ...
  // ####### Embed hooks #######
  // /!\ In embed scope, boomboom helpers are not available
  // ###########################
