 ...
 *
 * WebDAV and other codes useless with regards to BoomBoom are not listed.
 */
export const HttpStatusCode = {
   ...
   * teapots requested to brew coffee. This HTTP status is used as an Easter egg in some websites, including BoomBoom instances ;-).
   */
