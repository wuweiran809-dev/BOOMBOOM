...
```typescript
import { OpenaiTranscriber } from '@boomboom/boomboom-transcription'
...
```typescript
import { WhisperBuiltinModel } from '@boomboom/boomboom-transcription/dist'
...
```Typescript
import { transcriberFactory } from '@boomboom/boomboom-transcription'
