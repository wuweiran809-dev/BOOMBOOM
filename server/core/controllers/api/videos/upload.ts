import { ffprobePromise, getChaptersFromContainer } from '@boomboom/boomboom-ffmpeg'
import { isBoomBoomError, VideoCreate } from '@boomboom/boomboom-models'
...
async function addVideo (options: {
  ...
  try {
    ...
    if (isBoomBoomError(err) && err.code === 'INVALID_IMAGE_FILE') {
