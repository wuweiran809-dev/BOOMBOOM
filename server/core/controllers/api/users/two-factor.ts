...
import { encrypt } from '@server/helpers/boomboom-crypto.js'
...
import { HttpStatusCode, TwoFactorEnableResult } from '@boomboom/boomboom-models'
...
async function requestTwoFactor (req: express.Request, res: express.Response) {
  ...
  const encryptedSecret = await encrypt(secret, CONFIG.SECRETS.BOOMBOOM)
