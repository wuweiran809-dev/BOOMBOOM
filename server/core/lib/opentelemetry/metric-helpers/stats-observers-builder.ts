...
import { getAllPrivacies } from '@boomboom/boomboom-core-utils'
...
export class StatsObserversBuilder {
  ...
  private buildUserStatsObserver () {
    this.meter.createObservableGauge('boomboom_users_total', {
    ...
    this.meter.createObservableGauge('boomboom_active_users_total', {
  ...
  private buildChannelStatsObserver () {
    this.meter.createObservableGauge('boomboom_channels_total', {
    ...
    this.meter.createObservableGauge('boomboom_active_channels_total', {
  ...
  private buildVideoStatsObserver () {
    this.meter.createObservableGauge('boomboom_videos_total', {
    ...
    this.meter.createObservableGauge('boomboom_video_views_total', {
    ...
    this.meter.createObservableGauge('boomboom_video_downloads_total', {
    ...
    this.meter.createObservableGauge('boomboom_video_bytes_total', {
  ...
  private buildCommentStatsObserver () {
    this.meter.createObservableGauge('boomboom_comments_total', {
  ...
  private buildPlaylistStatsObserver () {
    this.meter.createObservableGauge('boomboom_playlists_total', {
  ...
  private buildInstanceFollowsStatsObserver () {
    this.meter.createObservableGauge('boomboom_instance_followers_total', {
    ...
    this.meter.createObservableGauge('boomboom_instance_following_total', {
  ...
  private buildRedundancyStatsObserver () {
    this.meter.createObservableGauge('boomboom_redundancy_used_bytes_total', {
    ...
    this.meter.createObservableGauge('boomboom_redundancy_available_bytes_total', {
  ...
  private buildActivityPubStatsObserver () {
    ...
    this.meter.createObservableGauge('boomboom_ap_inbox_success_total', {
    ...
    this.meter.createObservableGauge('boomboom_ap_inbox_error_total', {
    ...
    this.meter.createObservableGauge('boomboom_ap_inbox_waiting_total', {
