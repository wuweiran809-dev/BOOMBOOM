...
import { RunnerJobState } from '@boomboom/boomboom-models'
...
export class RunnerJobQueueObserversBuilder {
  ...
  buildObservers () {
    this.meter.createObservableGauge('boomboom_runner_job_queue_total', {
      description: 'Total jobs in the BoomBoom runner job queue'
