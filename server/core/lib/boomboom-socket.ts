...
import { LiveVideoEventPayload, LiveVideoEventType } from '@boomboom/boomboom-models'
import { logger } from '../helpers/logger.js'
import { authenticateRunnerSocket, authenticateSocket } from '../middlewares/index.js'
import { isDevInstance } from '@boomboom/boomboom-node-utils'

class BoomBoomSocket {
  private static instance: BoomBoomSocket
