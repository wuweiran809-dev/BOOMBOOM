import { doJSONRequest, BoomBoomRequestOptions } from '@server/helpers/requests.js'
import { CONFIG } from '@server/initializers/config.js'
import { ActivityObject, ActivityPubActor, ActivityType, APObjectId } from '@boomboom/boomboom-models'
...
export async function fetchAP <T> (url: string, moreOptions: BoomBoomRequestOptions = {}) {
  const options = {
    activityPub: true,
