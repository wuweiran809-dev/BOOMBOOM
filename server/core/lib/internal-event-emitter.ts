...
export interface BoomBoomInternalEvents {
...
declare interface InternalEventEmitter {
  on<U extends keyof BoomBoomInternalEvents>(
    event: U,
    listener: BoomBoomInternalEvents[U]
  ): this

  emit<U extends keyof BoomBoomInternalEvents>(
    event: U,
    ...args: Parameters<BoomBoomInternalEvents[U]>
  ): boolean
}
