import { findAppropriateImage, maxBy } from '@boomboom/boomboom-core-utils'
import {
  ActorImageType,
  HTMLServerConfig,
  LogoType,
...
import { CONSTRAINTS_FIELDS, DEFAULT_THEME_NAME, BOOMBOOM_VERSION, WEBSERVER } from '@server/initializers/constants.js'
...
class ServerConfigManager {
  ...
  async getHTMLServerConfig (): Promise<HTMLServerConfig> {
    ...
    return {
      ...
      serverVersion: BOOMBOOM_VERSION,
  ...
  getBuiltInThemes () {
    return [
      {
        name: 'boomboom-core-dark-brown' as 'boomboom-core-dark-brown'
      },
      {
        name: 'boomboom-core-light-beige' as 'boomboom-core-light-beige'
      }
    ]
  }
