import { FileStorage, UserExportState } from '@boomboom/boomboom-models'
import { getFileSize } from '@boomboom/boomboom-node-utils'
    ...
    return new Promise<void>(async (res, rej) => {
      ...
      try {
        for (const { exporter, jsonFilename } of this.buildExporters(exportModel, user)) {
          ...
          this.appendJSON(json, join('boomboom', jsonFilename))
