...
import { ffprobePromise, getVideoStreamDuration } from '@boomboom/boomboom-ffmpeg'
import { LiveVideoLatencyMode, VideoEmbedPrivacyPolicy, VideoExportJSON, VideoPrivacy, VideoState } from '@boomboom/boomboom-models'
import { buildUUID, getFileSize } from '@boomboom/boomboom-node-utils'
...
export class VideosImporter extends AbstractUserImporter<VideoExportJSON, ImportObject, SanitizedObject> {
  ...
  protected sanitize (o: ImportObject) {
    ...
    if (!o.firstPublishedAt || !isVideoPublicationDateValid(o.firstPublishedAt)) o.firstPublishedAt = null
