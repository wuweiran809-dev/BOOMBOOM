import { UserImportResultSummary, UserImportState } from '@boomboom/boomboom-models'
import { getFilenameWithoutExt, getFileSize } from '@boomboom/boomboom-node-utils'
...
export class UserImporter {
  ...
  private buildImporterOptions (user: MUserDefault, jsonFilename: string) {
    return {
      ...
      user,
      jsonFilePath: join(this.extractedDirectory, 'boomboom', jsonFilename)
    }
  }
