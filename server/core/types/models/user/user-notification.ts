...
import { PickWith, PickWithOpt } from '@boomboom/boomboom-typescript-utils'
...
export namespace UserNotificationIncludes {
  export type ActorImageInclude = Pick<
    ActorImageModel,
    'createdAt' | 'filename' | 'type' | 'getStaticPath' | 'getLocalFileUrl' | 'width' | 'updatedAt'
  >
  ...
  export type ApplicationInclude = Pick<ApplicationModel, 'latestBoomBoomVersion'>
  ...
  export type ChangeOwnershipInclude =
    ...
    & PickWith<ChangeOwnershipModel, 'VideoChannel', VideoChannelIncludeActor>
}
...
export type UserNotificationModelForApi =
  ...
  & Use<'ChangeOwnership', UserNotificationIncludes.ChangeOwnershipInclude>
