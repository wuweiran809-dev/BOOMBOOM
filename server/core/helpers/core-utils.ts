...
/*
  Different from 'utils' because we don't import other BoomBoom modules.
  Useful to avoid circular dependencies.
*/

import { promisify1, promisify2, promisify3 } from '@boomboom/boomboom-core-utils'
...
function boomboomTruncate (str: string, options: { length: number, separator?: RegExp, omission?: string }) {
