import { buildVideoEmbedPath, buildVideoWatchPath, forceNumber, maxBy, minBy, pick, wait } from '@boomboom/boomboom-core-utils'
import {
  FileStorage,
  ResultList,
...
import { boomboomTruncate } from '../../helpers/core-utils.js'
...
export class VideoModel extends SequelizeModel<VideoModel> {
  ...
  // BoomBoom paid unlock: coin price to watch this video (0 = free)
  @AllowNull(false)
  @Default(0)
  @Column
  ...
  private static async getAvailableForApi (
    ...
    const span = tracer.startSpan('boomboom.VideoModel.getAvailableForApi')
  ...
  getTruncatedDescription () {
    ...
    return boomboomTruncate(this.description, { length: maxLength })
  }
