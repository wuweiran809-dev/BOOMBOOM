import { findAppropriateImage, forceNumber, maxBy } from '@boomboom/boomboom-core-utils'
import { ActivityIconObject, ActorImageType, ActorImageType_Type, type ActivityPubActorType } from '@boomboom/boomboom-models'
...
export class ActorModel extends SequelizeModel<ActorModel> {
  ...
  // FIXME: have to specify the result type to not break boomboom typings generation
