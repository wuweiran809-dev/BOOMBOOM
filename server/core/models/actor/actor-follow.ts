import { ActorFollow, type FollowState } from '@boomboom/boomboom-models'
...
export class ActorFollowModel extends SequelizeModel<ActorFollowModel> {
  ...
  // Allow null because we added this column in BoomBoom v3, and don't want to generate fake URLs of remote follows
  @AllowNull(true)
