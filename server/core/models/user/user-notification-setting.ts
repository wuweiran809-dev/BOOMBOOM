import { type UserNotificationSetting, type UserNotificationSettingValueType } from '@boomboom/boomboom-models'
...
export class UserNotificationSettingModel extends SequelizeModel<UserNotificationSettingModel> {
  ...
  @Default(null)
  @Is(
    'UserNotificationSettingNewBoomBoomVersion',
    value => throwIfNotValid(value, isUserNotificationSettingValid, 'newBoomBoomVersion')
  )
  @Column
  declare newBoomBoomVersion: UserNotificationSettingValueType
  ...
  toFormattedJSON (this: MNotificationSettingFormattable): UserNotificationSetting {
    return {
      ...
      newBoomBoomVersion: this.newBoomBoomVersion,
