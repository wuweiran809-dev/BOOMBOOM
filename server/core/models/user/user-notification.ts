import { exists, forceNumber, maxBy } from '@boomboom/boomboom-core-utils'
import type { UserNotification, UserNotificationData, UserNotificationType_Type } from '@boomboom/boomboom-models'
...
export class UserNotificationModel extends SequelizeModel<UserNotificationModel> {
  ...
  toFormattedJSON (this: UserNotificationModelForApi): UserNotification {
    ...
    const boomboom = this.Application
      ? { latestVersion: this.Application.latestBoomBoomVersion }
      : undefined
