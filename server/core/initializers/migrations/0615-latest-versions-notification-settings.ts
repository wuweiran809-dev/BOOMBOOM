...
async function up (utils: {
  ...
  {
    const notificationSettingColumns = [ 'newBoomBoomVersion', 'newPluginVersion' ]
    ...
    {
      const query = 'UPDATE "userNotificationSetting" SET "newBoomBoomVersion" = 3, "newPluginVersion" = 1'
