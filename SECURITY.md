...
- Perform testing only on in-scope systems, and respect systems and activities which are out-of-scope. Systems currently considered in-scope are the official demonstration/test servers provided by the BoomBoom development team.
...
The vulnerability is kept private until a majority of instances known on instances.joinboomboom.org have updated to a safe version of BoomBoom or applied a hotfix. The BoomBoom development team coordinates efforts to update once the patch is issued.

## Official Channels

To help us receive vulnerability submissions we use the following official reporting channel:
- boomboom-security@framasoft.org
