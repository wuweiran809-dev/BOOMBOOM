...
import { BoomBoomResolution, PlayerEventType } from '../embed-player-api/definitions'
import { BoomBoomPlayer } from '../embed-player-api/player'
...
window.addEventListener('load', async () => {
  ...
  const player = new BoomBoomPlayer(document.querySelector('iframe'))
  ...
  const updateResolutions = (resolutions: BoomBoomResolution[]) => {
