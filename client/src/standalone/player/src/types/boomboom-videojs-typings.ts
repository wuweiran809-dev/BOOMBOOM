import { PlayerMode, VideoChapter, VideoFile, VideoPlaylist, VideoPlaylistElement } from '@boomboom/boomboom-models'
...
import { BoomBoomDockPlugin, BoomBoomDockPluginOptions } from '../shared/dock/boomboom-dock-plugin'
import { HotkeysOptions, BoomBoomHotkeysPlugin } from '../shared/hotkeys/boomboom-hotkeys-plugin'
import { BoomBoomMobilePlugin } from '../shared/mobile/boomboom-mobile-plugin'
import { BoomBoomNSFWPlugin, BoomBoomNSFWPluginOptions } from '../shared/nsfw/boomboom-nsfw-plugin'
...
import { BoomBoomPlugin } from '../shared/boomboom/boomboom-plugin'
import { PlaylistPlugin } from '../shared/playlist/playlist-plugin'
import { BoomBoomResolutionsPlugin } from '../shared/resolutions/boomboom-resolutions-plugin'
...
export type BoomBoomResolution = {
  id: number
...
export type BoomBoomPluginOptions = {
  autoPlayerRatio: {
...
export type BoomBoomLinkButtonOptions = {
  isDisplayed: () => boolean
  shortUUID: () => string
  instanceName: string
}
...
export type VideoJSPluginOptions = {
  ...
  boomboom: BoomBoomPluginOptions
...
export type VideojsPlayer = ReturnType<typeof videojs.getPlayer> & {
  ...
  boomboomResolutions(): BoomBoomResolutionsPlugin

  contextMenu(options?: ContextMenuPluginOptions): ContextMenuPlugin

  bezels(): BezelsPlugin
  boomboomMobile(): BoomBoomMobilePlugin
  boomBoomHotkeysPlugin(options?: HotkeysOptions): BoomBoomHotkeysPlugin

  stats(options?: StatsCardOptions): StatsForNerdsPlugin

  storyboard(options?: StoryboardOptions): StoryboardPlugin

  boomboomDock(options?: BoomBoomDockPluginOptions): BoomBoomDockPlugin
  boomboomNSFW(options?: BoomBoomNSFWPluginOptions): BoomBoomNSFWPlugin
