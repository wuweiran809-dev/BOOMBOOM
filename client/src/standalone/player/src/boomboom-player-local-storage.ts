...
import { boomboomLocalStorage, boomboomSessionStorage } from '@root-helpers/boomboom-web-storage'
...
const KEY_PREFIX = 'boomboom-videojs-'

function getLocalStorage (key: string) {
  return boomboomLocalStorage.getItem(KEY_PREFIX + key)
}

function setLocalStorage (key: string, value: string) {
  boomboomLocalStorage.setItem(KEY_PREFIX + key, value)
}

function removeLocalStorage (key: string) {
  boomboomLocalStorage.removeItem(KEY_PREFIX + key)
}

function getSessionStorage (key: string) {
  return boomboomSessionStorage.getItem(KEY_PREFIX + key)
}

function setSessionStorage (key: string, value: string) {
  boomboomSessionStorage.setItem(KEY_PREFIX + key, value)
}
