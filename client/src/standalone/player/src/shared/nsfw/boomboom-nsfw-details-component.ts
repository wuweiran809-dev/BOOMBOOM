import { NSFWFlag } from '@boomboom/boomboom-models'
...
class BoomBoomNSFWDetailsComponent extends Component {
...
videojs.registerComponent('BoomBoomNSFWDetailsComponent', BoomBoomNSFWDetailsComponent)

export {
  BoomBoomNSFWDetailsComponent
}
