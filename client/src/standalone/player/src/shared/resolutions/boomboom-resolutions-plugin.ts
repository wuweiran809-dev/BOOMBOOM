...
import { BoomBoomResolution, VideojsPlayer, VideojsPlugin } from '../../types'

const Plugin = videojs.getPlugin('plugin') as typeof VideojsPlugin

class BoomBoomResolutionsPlugin extends Plugin {
  declare private currentSelection: BoomBoomResolution
  declare private resolutions: BoomBoomResolution[]
  ...
  add (resolutions: BoomBoomResolution[]) {
...
videojs.registerPlugin('boomboomResolutions', BoomBoomResolutionsPlugin)
export { BoomBoomResolutionsPlugin }
