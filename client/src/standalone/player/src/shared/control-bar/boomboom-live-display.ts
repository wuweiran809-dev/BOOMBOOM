...
import { BoomBoomLinkButtonOptions, VideojsClickableComponent, VideojsClickableComponentOptions, VideojsPlayer } from '../../types'

const ClickableComponent = videojs.getComponent('ClickableComponent') as typeof VideojsClickableComponent

class BoomBoomLiveDisplay extends ClickableComponent {
  declare private interval: any

  declare private contentEl_: HTMLElement

  constructor (player: VideojsPlayer, options?: VideojsClickableComponentOptions & BoomBoomLinkButtonOptions) {
...
videojs.registerComponent('BoomBoomLiveDisplay', BoomBoomLiveDisplay)
