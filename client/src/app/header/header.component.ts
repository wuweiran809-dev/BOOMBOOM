...
import { findAppropriateImage, getCompleteLocale, I18N_LOCALES } from '@boomboom/boomboom-core-utils'
import { HTMLServerConfig, ServerConfig } from '@boomboom/boomboom-models'
...
export class HeaderComponent implements OnInit, OnDestroy {
  ...
  private modalService = inject(BoomboomModalService)
  ...
  private setupMobileMsg () {
    ...
    if (boomboomLocalStorage.getItem(HeaderComponent.LS_HIDE_MOBILE_MSG) === 'true') return
    ...
    this.router.events.subscribe(event => {
      ...
      const baseIOS = `boomboom://${iosConfig.host}`
  ...
  hideMobileMsg () {
    ...
    boomboomLocalStorage.setItem(HeaderComponent.LS_HIDE_MOBILE_MSG, 'true')
  }
