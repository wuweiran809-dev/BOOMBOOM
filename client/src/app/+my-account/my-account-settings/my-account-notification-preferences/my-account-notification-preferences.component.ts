...
import { UserNotificationSetting, UserNotificationSettingValue, UserRight, UserRightType } from '@boomboom/boomboom-models'
...
export class MyAccountNotificationPreferencesComponent implements OnInit {
  ...
  constructor () {
    ...
    this.rightNotifications = {
      ...
      newBoomBoomVersion: UserRight.MANAGE_DEBUG,
  ...
  ngOnInit () {
    ...
    this.labelNotifications = {
      ...
      newBoomBoomVersion: $localize`A new BoomBoom version is available`,
