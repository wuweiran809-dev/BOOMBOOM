...
import { BoomBoomProblemDocument, ServerErrorCode, UserExport, UserExportState } from '@boomboom/boomboom-models'
...
@Component({
  ...
  imports: [ GlobalIconComponent, BoomboomCheckboxComponent, FormsModule, PTDatePipe, BytesPipe, AlertComponent ]
})
  ...
  requestNewArchive () {
    ...
    baseObs.pipe(
      ...
      error: err => {
        ...
        const error = err.body as BoomBoomProblemDocument
