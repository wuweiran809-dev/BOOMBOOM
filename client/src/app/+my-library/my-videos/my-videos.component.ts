...
import { VideoChannel, VideoExistInPlaylist, VideoPrivacy, VideoPrivacyType, VideosExistInPlaylists } from '@boomboom/boomboom-models'
...
export class MyVideosComponent implements OnInit, OnDestroy {
  ...
  private badgeService = inject(BoomBoomBadgeService)
