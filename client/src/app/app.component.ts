...
import { getShortLocale } from '@boomboom/boomboom-core-utils'
import { BroadcastMessageLevel, HTMLServerConfig, UserRole } from '@boomboom/boomboom-models'
...
import { BoomboomModalService } from './shared/shared-main/boomboom-modal/boomboom-modal.service'
import { MobileTabBarComponent } from './layout/mobile-tab-bar/mobile-tab-bar.component'
...
export class AppComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit () {
    ...
    this.boomboomModal.openAdminConfigWizardSubject.subscribe(({ showWelcome }) => {
  ...
  hideBroadcastMessage () {
    boomboomLocalStorage.setItem(AppComponent.LS_BROADCAST_MESSAGE, this.serverConfig.broadcastMessage.message)
  ...
  private initRouteEvents () {
    ...
    // Plugin hooks
    this.boomboomRouter.getNavigationEndEvents().subscribe(e => {
