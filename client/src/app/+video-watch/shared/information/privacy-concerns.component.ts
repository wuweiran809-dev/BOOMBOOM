...
import { HTMLServerConfig, Video } from '@boomboom/boomboom-models'
...
export class PrivacyConcernsComponent implements OnInit {
  ...
  acceptedPrivacyConcern () {
    boomboomLocalStorage.setItem(PrivacyConcernsComponent.LS_PRIVACY_CONCERN_KEY, 'true')
  ...
  private alreadyAccepted () {
    return boomboomLocalStorage.getItem(PrivacyConcernsComponent.LS_PRIVACY_CONCERN_KEY) === 'true'
  }
}
