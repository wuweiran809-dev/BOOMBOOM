...
import { AuthService, AuthStatus, LocalStorageService, BoomBoomRouterService, User, UserService } from '@app/core'
...
export class QuickSettingsModalComponent implements OnInit, OnDestroy {
  ...
  private setModalQuery (type: 'add' | 'remove') {
    ...
    this.boomboomRouter.silentNavigate([], { modal }, this.route)
  }
}
