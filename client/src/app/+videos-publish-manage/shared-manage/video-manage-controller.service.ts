...
import { AuthService, ConfirmService, Notifier, BoomBoomRouterService } from '@app/core'
...
const debugLogger = debug('boomboom:video-manage')
...
export class VideoManageController implements OnDestroy {
  ...
  silentRedirectOnManage (shortUUID: string, route: ActivatedRoute) {
    this.boomboomRouter.silentNavigate([ '.' ], { publishedId: shortUUID, uploading: null }, route)
  }

  silentRedirectOnUploading (route: ActivatedRoute) {
    this.boomboomRouter.silentNavigate([ '.' ], { publishedId: null, uploading: 'true' }, route)
  }

  silentRedirectOnAbortUpload (route: ActivatedRoute) {
    this.boomboomRouter.silentNavigate([ '.' ], { publishedId: null, uploading: null }, route)
  }
