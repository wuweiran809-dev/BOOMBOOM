...
import { millisecondsToVttTime, sortBy, timeToInt } from '@boomboom/boomboom-core-utils'
import { HTMLServerConfig, ConstantLabel } from '@boomboom/boomboom-models'
import { parse } from '@plussub/srt-vtt-parser'
import { BoomBoomPlayer } from '../../../../standalone/embed-player-api/player'
...
export class VideoCaptionEditModalComponent extends FormReactive implements OnInit {
  ...
  initEmbed () {
    ...
    if (embed) {
      this.player = new BoomBoomPlayer(embed.getIframe())
