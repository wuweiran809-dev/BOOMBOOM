...
import { BoomBoomPluginIndex, PluginType, PluginType_Type } from '@boomboom/boomboom-models'
...
export class PluginSearchComponent implements OnInit {
  ...
  isInstalling (plugin: BoomBoomPluginIndex) {
    return !!this.installing[plugin.npmName]
  }

  getShowRouterLink (plugin: BoomBoomPluginIndex) {
  ...
  async install (plugin: BoomBoomPluginIndex) {
