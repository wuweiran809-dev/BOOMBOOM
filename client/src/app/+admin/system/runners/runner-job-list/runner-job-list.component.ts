...
import { BoomBoomBadgeService } from '@app/shared/shared-main/common/boomboom-badge.service'
import { RunnerJob, RunnerJobState, RunnerJobStateType, RunnerJobType } from '@boomboom/boomboom-models'
...
export class RunnerJobListComponent implements OnInit {
  ...
  private boomboomBadgeService = inject(BoomBoomBadgeService)
  ...
  getRandomRunnerNameBadge (value: string) {
    return this.boomboomBadgeService.getRandomBadge('runner', value)
  }

  getRandomRunnerTypeBadge (value: string) {
    return this.boomboomBadgeService.getRandomBadge('type', value)
  }
