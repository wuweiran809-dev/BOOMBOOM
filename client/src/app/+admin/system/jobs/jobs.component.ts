...
import { Job, JobState, JobType } from '@boomboom/boomboom-models'
import { arrayOfAllFactory } from '@boomboom/boomboom-typescript-utils'
...
export class JobsComponent {
  ...
  getRandomJobTypeBadge (type: string) {
    return this.boomboomBadgeService.getRandomBadge('type', type)
  }
