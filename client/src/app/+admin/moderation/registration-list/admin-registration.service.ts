...
import { ResultList, UserRegistration, UserRegistrationStateType, UserRegistrationUpdateState } from '@boomboom/boomboom-models'
...
export class AdminRegistrationService {
  ...
  listRegistrations (options: {
    ...
    const { pagination, sort, search, stateOneOf } = options
    ...
    params = this.restService.addObjectParams(params, { stateOneOf })
