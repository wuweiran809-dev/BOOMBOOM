...
import { UserRegistration } from '@boomboom/boomboom-models'
...
@Component({
  ...
  imports: [ CommonModule, GlobalIconComponent, FormsModule, ReactiveFormsModule, BoomboomCheckboxComponent, AlertComponent ]
})
