...
export class PluginApiService {
  ...
  getPlugins (
    ...
    return this.authHttp.get<ResultList<BoomBoomPlugin>>(PluginApiService.BASE_PLUGIN_URL, { params })
  ...
  searchAvailablePlugins (
    ...
    return this.authHttp.get<ResultList<BoomBoomPluginIndex>>(PluginApiService.BASE_PLUGIN_URL + '/available', { params })
      .pipe(catchError(res => this.restExtractor.handleError(res)))
  }
  ...
  getPlugin (npmName: string) {
    ...
    return this.authHttp.get<BoomBoomPlugin>(path)
      .pipe(catchError(res => this.restExtractor.handleError(res)))
  }
  ...
  getPluginOrThemeHref (type: PluginType_Type, name: string) {
    ...
    return `https://www.npmjs.com/package/boomboom-${typeString}-${name}`
  }
}
