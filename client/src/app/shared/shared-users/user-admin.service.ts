...
import { arrayify, boomboomTranslate } from '@boomboom/boomboom-core-utils'
import { ResultList, UserCreate, UserRoleType, User as UserServerModel, UserUpdate } from '@boomboom/boomboom-models'
...
export class UserAdminService {
  ...
  private formatUser (user: UserServerModel, translations: { [id: string]: string } = {}): UserAdmin {
    ...
    return Object.assign(user, {
      role: {
        id: user.role.id,
        label: boomboomTranslate(user.role.label, translations)
      },
      videoQuota,
      videoQuotaUsed,
