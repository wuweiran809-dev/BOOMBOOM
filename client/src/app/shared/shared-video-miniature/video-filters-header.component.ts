...
import { UserRight, ConstantLabel } from '@boomboom/boomboom-models'
...
import { BoomboomModalService } from '../shared-main/boomboom-modal/boomboom-modal.service'
import { VideoFilterActive, VideoFilters } from './video-filters.model'

const debugLogger = debug('boomboom:videos:VideoFiltersHeaderComponent')
