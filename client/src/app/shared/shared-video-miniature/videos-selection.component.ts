...
import { objectKeysTyped } from '@boomboom/boomboom-core-utils'
import { ResultList, VideoSortField } from '@boomboom/boomboom-models'
...
import { BoomBoomTemplateDirective } from '../shared-main/common/boomboom-template.directive'
...
@Component({
  ...
  imports: [ InfiniteScrollerDirective, BoomboomCheckboxComponent, FormsModule, VideoMiniatureComponent, NgTemplateOutlet ]
})
export class VideosSelectionComponent implements AfterContentInit {
  ...
  readonly templates = contentChildren(BoomBoomTemplateDirective)
