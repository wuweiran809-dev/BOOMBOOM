...
import { abusePredefinedReasonsMap } from '@boomboom/boomboom-core-utils'
import { AbusePredefinedReasonsString } from '@boomboom/boomboom-models'
...
export class CommentReportComponent extends FormReactive implements OnInit {
  ...
  ngOnInit () {
    ...
    this.predefinedReasons = this.abuseService.getPredefinedReasons('comment')
  }
