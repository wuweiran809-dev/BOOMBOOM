...
@Component({
  selector: 'my-boomboom-checkbox',
  styleUrls: [ './boomboom-checkbox.component.scss' ],
  templateUrl: './boomboom-checkbox.component.html',
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => BoomboomCheckboxComponent),
      multi: true
    }
  ],
...
export class BoomboomCheckboxComponent implements ControlValueAccessor, AfterContentInit {
