...
import { objectKeysTyped, boomboomTranslate } from '@boomboom/boomboom-core-utils'
import { About } from '@boomboom/boomboom-models'
      ...
      map(([ languagesArray, translations ]) => {
        return about.instance.languages
          .map(l => {
            ...
            return boomboomTranslate(languageObj.label, translations)
          })
      })
    )
  }
      ...
      map(([ categoriesArray, translations ]) => {
        return about.instance.categories
          .map(c => {
            ...
            return boomboomTranslate(categoryObj.label, translations)
          })
      })
    )
  }
