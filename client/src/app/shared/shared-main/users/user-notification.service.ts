...
import { AuthService, ComponentPaginationLight, BoomBoomSocket, RestExtractor, RestService } from '@app/core'
import { NGX_LOADING_BAR_IGNORED } from '@ngx-loading-bar/http-client'
import { ResultList, UserNotification as UserNotificationServer, UserNotificationSetting } from '@boomboom/boomboom-models'
...
export class UserNotificationService {
  ...
  markAsRead (notification: UserNotification) {
    ...
    return this.authHttp.post(url, body, { context })
      .pipe(
        tap(() => this.boomboomSocket.dispatchNotificationEvent('read')),
  ...
  markAllAsRead () {
    ...
    return this.authHttp.post(url, {}, { context })
      .pipe(
        tap(() => this.boomboomSocket.dispatchNotificationEvent('read-all')),
        catchError(res => this.restExtractor.handleError(res))
      )
  }
