...
import { buildVideoWatchPath, getAllFiles, boomboomTranslate } from '@boomboom/boomboom-core-utils'
import {
  ActorImage,
  ConstantLabel,
  HTMLServerConfig,
...
export class Video implements VideoServerModel {
  ...
  constructor (hash: VideoServerModel, translations: { [id: string]: string } = {}) {
    ...
    this.category.label = boomboomTranslate(this.category.label, translations)
    this.licence.label = boomboomTranslate(this.licence.label, translations)
    this.language.label = boomboomTranslate(this.language.label, translations)
    this.privacy.label = boomboomTranslate(this.privacy.label, translations)
    ...
    if (this.state) this.state.label = boomboomTranslate(this.state.label, translations)
    ...
    for (const file of this.getAllVideoFiles()) {
      file.resolution.label = boomboomTranslate(file.resolution.label, translations)
    }
