...
import { getCompleteLocale, getKeys, isDefaultLocale, objectKeysTyped, boomboomTranslate } from '@boomboom/boomboom-core-utils'
import {
...
export class PluginService implements ClientHook {
  ...
  constructor () {
    ...
    this.pluginsManager = new PluginsManager({
      ...
      boomboomHelpersFactory: this.buildBoomBoomHelpers.bind(this),
  ...
  translateBy (npmName: string, toTranslate: string) {
    const obs = this.translationsObservable
      .pipe(
        ...
        map(translations => boomboomTranslate(toTranslate, translations))
      )
  ...
  private buildBoomBoomHelpers (pluginInfo: PluginInfo): RegisterClientHelpers {
