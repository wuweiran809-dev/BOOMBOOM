...
import { BoomBoomRouterService } from '../routing'
import { LocalStorageService, ScreenService } from '../wrappers'

const debugLogger = debug('boomboom:menu')

@Injectable()
export class MenuService {
  private screenService = inject(ScreenService)
  private localStorageService = inject(LocalStorageService)
  private boomboomRouterService = inject(BoomBoomRouterService)
  ...
  constructor () {
    ...
    this.boomboomRouterService.getNavigationEndEvents()
      .subscribe(e => {
