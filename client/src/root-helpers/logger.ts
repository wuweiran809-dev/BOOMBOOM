import { ClientLogCreate } from '@boomboom/boomboom-models'
import { boomboomLocalStorage } from './boomboom-web-storage'
...
class Logger {
  ...
  sendClientLog (serverUrl: string, payload: ClientLogCreate | null) {
    ...
    try {
      const tokens = OAuthUserTokens.getUserTokens(boomboomLocalStorage)
