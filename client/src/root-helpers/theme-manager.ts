import { sortBy } from '@boomboom/boomboom-core-utils'
...
const debugLogger = debug('boomboom:theme')
  ...
  private _injectColorPalette () {
    try {
      ...
      for (const { prefix, invertIfDark, step, darkTheme, fallbacks = {} } of toProcess) {
        ...
        // Use trim for some web browsers: https://github.com/Chocobozzz/BoomBoom/issues/6952
