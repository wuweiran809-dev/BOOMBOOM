...
import { getExternalAuthHref, getHookType, internalRunHook } from '@boomboom/boomboom-core-utils'
import {
  ClientDoAction,
  ClientHookName,
  clientHookObject,
...
type BoomboomHelpersFactory = (pluginInfo: PluginInfo) => RegisterClientHelpers
...
const debugLogger = debug('boomboom:plugins')
...
class PluginsManager {
  ...
  private readonly boomboomHelpersFactory: BoomboomHelpersFactory
  ...
  constructor (options: {
    ...
    boomboomHelpersFactory: BoomboomHelpersFactory
    ...
    this.boomboomHelpersFactory = options.boomboomHelpersFactory
  ...
  private loadPlugin (pluginInfo: PluginInfo) {
    ...
    const boomboomHelpers = this.boomboomHelpersFactory(pluginInfo)
