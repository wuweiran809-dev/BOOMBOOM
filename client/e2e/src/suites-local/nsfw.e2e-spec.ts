import { NSFWPolicyType } from '@boomboom/boomboom-models'
...
describe('NSFW', () => {
  ...
  describe('Preparation', function () {
    ...
    it('Should set the homepage', async () => {
      await adminConfigPage.updateHomepage('<boomboom-videos-list data-sort="-publishedAt"></boomboom-videos-list>')
      await adminConfigPage.save()
    })
