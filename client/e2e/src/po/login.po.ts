...
export class LoginPage {
  ...
  loginOnBoomBoom2 () {
    if (!process.env.BOOMBOOM2_E2E_PASSWORD) {
      throw new Error('BOOMBOOM2_E2E_PASSWORD env is missing for user e2e on boomboom2.cpy.re')
    }

    return this.login({ username: 'e2e', password: process.env.BOOMBOOM2_E2E_PASSWORD, url: 'https://boomboom2.cpy.re/login' })
  }
