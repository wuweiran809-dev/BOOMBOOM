...
export class IPCClient {
  ...
  async askRegister (options: {
    ...
    if (success) console.log('BoomBoom instance registered')
    else console.error('Could not register BoomBoom instance on runner server side', error)
  }
  ...
  async askUnregister (options: {
    ...
    if (success) console.log('BoomBoom instance unregistered')
    else console.error('Could not unregister BoomBoom instance on runner server side', error)
  }
  ...
  async askListRegistered () {
    ...
    if (!success) {
      console.error('Could not list registered BoomBoom instances', error)
      return
    }
