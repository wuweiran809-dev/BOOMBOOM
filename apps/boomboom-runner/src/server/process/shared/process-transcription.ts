import { hasAudioStream } from '@boomboom/boomboom-ffmpeg'
import { RunnerJobTranscriptionPayload, TranscriptionSuccess } from '@boomboom/boomboom-models'
import { buildSUUID } from '@boomboom/boomboom-node-utils'
import { TranscriptionModel, WhisperBuiltinModel, transcriberFactory } from '@boomboom/boomboom-transcription'
