...
Source files are in `client/src/locale` and translated files merged from [Weblate](https://weblate.framasoft.org/projects/boomboom/).
 ...
 * Lock [weblate project](https://weblate.framasoft.org/projects/boomboom)
