...
Then, if you think there are enough translated strings, please [create an issue](https://github.com/Chocobozzz/BoomBoom/issues) so we add the new locale in BoomBoom!

Translations are manually pulled and merged in BoomBoom software and are publicly available in the next official release.
You can get a chance to see translations before the official release by going to https://boomboom2.cpy.re which is updated every night with the latest BoomBoom changes.
 ...
 * To translate the BoomBoom web, visit the BoomBoom project page: https://weblate.framasoft.org/projects/boomboom/
 * To translate the BoomBoom mobile application, visit the BoomBoom App project page: https://weblate.framasoft.org/projects/boomboom-app/
 ...
 * **server**: contains server strings clients can fetch in JSON format so they don't have to translate common BoomBoom strings themselves (iso639 languages, privacies, licences...)
