import { CLICommand } from '@boomboom/boomboom-server-commands'
...
async function run () {
...

  {
    ...
    console.log(' * `boomboom-x` by Solen DP (CC-BY)')
...

  {
    ...
    console.log(
      `*We ran [a crowdfunding campaign](https://joinboomboom.org/roadmap) in 2020 to implement live streaming to the version ` +
        `3.0.0 of BoomBoom. Thanks to everyone who pitched in and shared the news!*\n\n`
    )
  }

  {
    ...
    console.log(
      `\n*We ran [a crowdfunding campaign](https://www.kisskissbankbank.com/en/projects/boomboom-a-free-and-federated-video-platform) ` +
        `in 2018 to pave the road to the version 1.0.0 of BoomBoom, with 1,379 backers. ` +
