import { Video, VideoPrivacy } from '@boomboom/boomboom-models'
import {
  createSingleServer,
  doubleFollow,
  killallServers,
...
async function run () {
  ...
  const tests = [
    {
      title: 'AP - account boomboom',
      path: '/accounts/boomboom',
    ...
    {
      title: 'Misc - webfinger boomboom',
      path: '/.well-known/webfinger?resource=acct:boomboom@' + server.host,
      expecter: (body, status) => {
